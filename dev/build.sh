...
export APP_NAME="Rush"
export ASSETS_REPOSITORY="rush-automations/rush"
export BINARY_NAME="rush"
export CI_BUILD="no"
export GH_REPO_PATH="rush-automations/rush"
export ORG_NAME="Rush Automations"
...
while getopts ":ilops" opt; do
  case "$opt" in
    i)
      export ASSETS_REPOSITORY="rush-automations/rush-insiders"
      export BINARY_NAME="rush-insiders"

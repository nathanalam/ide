...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Rush - Insiders"
  PRODUCT_CODE="RushInsiders"
...
if [[ -z "${1}" ]]; then
  OUTPUT_BASE_FILENAME="Rush-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
  OUTPUT_BASE_FILENAME="Rush-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
